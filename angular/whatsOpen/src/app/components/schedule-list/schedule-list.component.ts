...
export class ScheduleListComponent implements OnInit {
	...
	ngOnInit(): void {
		this.dataSource.paginator = this.paginator; // links paginator to data source
	}
	...
	@ViewChild(MatPaginator, { static: true }) paginator: MatPaginator; // scans for paginator in HTML
}
